...
| Future predictions | 768-dimensional adapter | 996,368 |
| Action policy | 46 actions | 47,150 |
| Total |  | 26,607,356 |

The state branch produces 830 values through a 1024-wide adapter. The future branch produces 272 values through a 768-wide adapter. Neither adapter imposes a low-rank output bottleneck.
