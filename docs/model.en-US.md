...
The state branch produces 806 values through a 1024-wide adapter. The future branch produces 264 values through a 768-wide adapter. Neither adapter imposes a low-rank output bottleneck.
